        ...
        <div class="box-tools">
            ...
            <table id="user" class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                    <a href="<?= site_url('admin/CrudWarga/edit/'.$warga->id_warga)?>" class="btn btn-success" role="button" title="Ubah Data"><i class="glyphicon glyphicon-edit"></i></a>
                    <a href="<?= site_url('admin/CrudWarga/hapus/'.$warga->id_warga)?>" class="btn btn-danger" role="button" title="Hapus Data"><i class="glyphicon glyphicon-trash"></i></a>
                </td>
                </tr>
                <?php } ?>
                </tbody>
