      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <form  action="<?php echo base_url().'rt/CrudWarga/tambah_aksi';?>" method="post" enctype="multipart/form-data">
            <div class="box-body">
                <div class="form-group">
                <label for="NKK">NKK</label>
                <input class="form-control <?php echo form_error('NKK') ? 'is-invalid':'' ?>" type="text" name="NKK" placeholder="NKK"/>
